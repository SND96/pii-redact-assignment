...
def evaluate_redactions(pred_spans: List[Dict], gold_spans: List[Dict]) -> Tuple[int, int, int, Dict[str, Dict[str, int]]]:
    """
...
def evaluate_redaction_file(json_file_path: str, per_label: bool = False) -> Dict:
    """
...
if __name__ == "__main__":
    ...
    results = evaluate_redaction_file(args.file, args.per_label)
